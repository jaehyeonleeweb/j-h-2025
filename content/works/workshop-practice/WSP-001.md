...
extra:
  ...
  thumbnail: "{{ get_url(path="media/works/workshop-practice/thumbnail/thumbnail_001_workshop about shynthesizer-dct synthesizing i.webp") }}"
---
***
...
<figure class="img--fixed" style="max-width:360px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/jpg image.webp") }}" alt="JPG Image">
...
<figure class="img--bordered img--fixed" style="max-width:360px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct 8x8.webp") }}" alt="DCT 8x8">
...
<figure class="img--bordered img--fixed" style="max-width:370px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct 2x2 Basics.webp") }}" alt="dct 2x2 basics">
...
<figure class="img--bordered img--fixed" style="max-width:410px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct images A.webp") }}" alt="dct images A">
...
<figure class="img--bordered img--fixed" style="max-width:810px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct images B.webp") }}" alt="dct images B">
  <figcaption>Shape Image Combination B, 96 types (removing duplicate images from 120 combination pairs)</figcaption>
</figure>
<br>
<figure class="img--bordered img--fixed" style="max-width:810px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct images C.webp") }}" alt="dct images C">
  <figcaption>Shape Image Combination C, 192 types (removing duplicate images from 240 combination pairs)</figcaption>
</figure>

<br>
<figure class="img--bordered img--fixed" style="max-width:810px;">
  <img src="{{ get_url(path="media/works/workshop-practice/wsp-001/dct images D.webp") }}" alt="dct images D">
