...
extra:
  ...
  date_year: 2025
  date_ym: "Nov 2025"
  thumbnail: "{{ get_url(path="media/works/workshop/thumbnail/thumbnail_001_workshop about shynthesizer.webp") }}"
---
***
...
<figure class="img--bordered img--fixed" style="max-width:600px;">
  <img src="{{ get_url(path="media/works/workshop/analog synth 101.webp") }}" alt="Analog Synth 101 Diagram">
...
<figure class="img--fixed" style="max-width:240px;">
  <img src="{{ get_url(path="media/works/workshop/paik abe video synthesizer.webp") }}" alt="Paik-Abe Video Synthesizer">
