...
extra:
  ...
  thumbnail: "{{ get_url(path="media/works/project/thumbnail/thumbnail_001_dongle demo.webp") }}"
---
Dongle is a modular typeface based on a 3x5 square cell [module](/method/mt-001/).
<br>
<figure class="img--full">
  <img src="{{ get_url(path="media/works/project/pr-001/dongle line.webp") }}" alt="Dongle Demo Line">
</figure>
...
<div class="img-grid cols-2"><figure class="grid-2">
  <img src="{{ get_url(path="media/works/project/pr-001/dongle regular letter set.webp") }}" alt="Dongle Demo Regular Letters">
  <figcaption>Dongle Regular (Letter set)</figcaption>
</figure><figure class="grid-2">
  <img src="{{ get_url(path="media/works/project/pr-001/dongle line letter set.webp") }}" alt="Dongle Demo Line Letters">
...
### Font Download:  
1. [DongleDemo-Regular.otf ]({{ get_url(path="media/works/project/files/DongleDemo-Regular.otf") }})
2. [DongleDemo-Line.otf]({{ get_url(path="media/works/project/files/DongleDemo-Line.otf") }})