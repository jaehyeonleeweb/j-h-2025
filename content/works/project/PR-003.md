...
extra:
  ...
  thumbnail: "{{ get_url(path="media/works/project/thumbnail/thumbnail_003_random silhouette.webp") }}"
---
...
<figure class="img--full">
  <img src="{{ get_url(path="media/works/project/pr-003/random silhouette.webp") }}" alt="random silhouette 600">
